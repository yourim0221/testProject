...
<body>
	...
	<div class="mainWrapScheduleAdd" align="center">
		...
		<div class="setScheduleOption">
			<jsp:include page="/views/schedule/schetemplates/schAdd001setSchedetail.jsp"></jsp:include>
		</div>
		
		<!-- 타임라인에 스케쥴을 추가하는 부분 -->
		<div class="scheAdder">
			<jsp:include page="/views/schedule/schetemplates/schAdd002scheAdddetail.jsp"></jsp:include>
		</div>
		
		<!-- 지도와 각 관음숙의 정보가 표시되는 부분 -->
		<div class="mapAboutEachSights">
			<jsp:include page="/views/schedule/schetemplates/schAdd003mapdetail.jsp"></jsp:include>
		</div>
		
		<!-- 유저가 선택한 타임라인을 보여주는 부분 -->
		<div class="addedScheTimeline">
			<jsp:include page="/views/schedule/schetemplates/schAdd004timelinedetail.jsp"></jsp:include>
		</div>	
		
	<!-- 관음숙 랭킹을 보여주는 부분 -->
		<div class="sightsRankDiagram">
			<jsp:include page="/views/schedule/schetemplates/schAdd005_1rankdetail.jsp"></jsp:include>
		</div>
